...
def collapse(by_roi, roi_to_patient, race):
	...
	for t_roi in by_roi:
		...
		scores[t_roi] = np.mean(by_roi[t_roi]) #previous
	...
	for t_patient in by_patient:
		...
		new_score = np.min(by_patient[t_patient]) #previous
...
if __name__=="__main__":
	M1 = [\
	"10 CD68--9 GranzymeB CD152 HIF1a.txt", \
	"10 CD68--12 CD16 CD163 CD68.txt", \
	"15 CD4 CD3--15 CD4 CD3.txt", \
	"7 CD152 CD8a--9 GranzymeB CD152 HIF1a.txt", \
	"11 CD3 CD45 CD4 CD8a CD45RO--15 CD4 CD3.txt", \
	"6 HIF1a--9 GranzymeB CD152 HIF1a.txt", \
	"12 CD16 CD163 CD68--12 CD16 CD163 CD68.txt", \
	"11 CD3 CD45 CD4 CD8a CD45RO--7 CD152 CD8a.txt", \
	"9 GranzymeB CD152 HIF1a--9 GranzymeB CD152 HIF1a.txt", \
	"10 CD68--15 CD4 CD3.txt", \
	"11 CD3 CD45 CD4 CD8a CD45RO--14 CD45 CD45RA CD45RO.txt", \
	"11 CD3 CD45 CD4 CD8a CD45RO--9 GranzymeB CD152 HIF1a.txt", \
	"11 CD3 CD45 CD4 CD8a CD45RO--11 CD3 CD45 CD4 CD8a CD45RO.txt", \
	"12 CD16 CD163 CD68--7 CD152 CD8a.txt", \
	"15 CD4 CD3--7 CD152 CD8a.txt", \
	]

	M2 = ["19 PLK1 PD1--8 PLK1 PanCK Ki67.txt"]

	M3 = ["1 CD16 CD163 PDL1--1 CD16 CD163 PDL1.txt"]

	M0 = ["13 CD31 Vimentin AR--13 CD31 Vimentin AR.txt"]

	M4 = [\
	"16 PanCK VEGF ECadherin--17 KIFC1 GranzymeB Ki67.txt", \
	"16 PanCK VEGF ECadherin--2 PanCK.txt", \
	"17 KIFC1 GranzymeB Ki67--2 PanCK.txt", \
	"16 PanCK VEGF ECadherin--16 PanCK VEGF ECadherin.txt", \
	]
	...
	fw = open("survival.EA.all.module.%s.h" % sample, "w")

	fw.write("patient\trace\tstage\tage\tEAscore\ttime\tstatus\tgroup\tregionalnodes\tbmi\tdm\tpik3ca\tgrade\ttreatment\ttp53\tras\tmets\n")
